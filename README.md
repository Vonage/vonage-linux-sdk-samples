...
Vonage Linux SDK. Feel free to copy and modify the source code herein for your
own projects.

Please consider sharing your modifications with us, especially if they might
benefit other developers using the Vonage Linux SDK. See the License for more
information.
...
This sample application shows you how to connect to an Vonage session, publish
a stream, and subscribe to a stream. It implements a simple video call
application with several clients. If you're just getting started with Vonage,
...
want to publish an audio-video stream to an Vonage session, without subscribing to
...
capturer pipes the RTSP stream into a Vonage session.
